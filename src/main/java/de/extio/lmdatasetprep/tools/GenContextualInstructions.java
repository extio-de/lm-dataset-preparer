...
@Component
public class GenContextualInstructions extends AbstractContextualPrompts {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(GenContextualInstructions.class);
